  ...
  return (
    <section id="contact" className="md:px-20 px-5 py-20 h-auto min-h-dvh">
        ...
        <div className="flex flex-col justify-center items-center gap-5 text-center my-10">
          <h2 className="anim text-5xl font-semibold text-blue-600">Let's collaborate!</h2>
          <p className="anim text-2xl">Contact me to discuss your web development needs <br/> or just to say hello. 😉</p>
        </div>
