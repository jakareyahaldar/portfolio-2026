...
export default function ProjectCard() {
  return (
    <div className="p-5 rounded-2xl grid gap-4 hover:bg-blue-950 hover:-translate-y-2 transition duration-1000">
        <div>
            <Image className="w-full rounded-md" src={"/project_images/galaxy.png"} alt="Project" height={1000} width={1500} />
        </div>
        <div className="flex items-center justify-between">
           <div className="flex gap-5 items-center">
                <Image className="w-20 h-20 rounded-md"  src={"/project_images/galaxy_logo.png"} alt="Project" height={100} width={150} />
                <h3 className="text-2xl">Galaxy</h3>
           </div>
           <div className="flex gap-5 items-center">
